...
const I18N = {
  ru: {
    ...
    'f1d': 'CPU, память, диск и сеть с обновлением раз в секунду.',
    'f2t': 'История метрик',
    ...
    'f6t': 'Очистка системы',
    'f6d': 'Корзина, кэши, /var/log, systemd journal, кэш pacman и пакеты-сироты.',
    'f7t': '/etc/hosts',
    ...
    'res.t': 'Ресурсы',
    'res.d': 'Пять графиков с историей за 60 секунд. Данные накапливаются, пока приложение запущено, и не сбрасываются при переходе между страницами.',
    ...
    'clean.d': 'Шесть категорий с подсчётом размера. Отмечаете нужные пункты — приложение показывает итоговый объём и удаляет выбранное; выбор сохраняется между запусками.',
    'clean.a': 'Корзина, кэши приложений, отчёты о сбоях',
    'clean.b': 'Системные журналы и обрезка systemd journal до 50 МБ',
  ...
  en: {
    ...
    'f1d': 'CPU, memory, disk and network, refreshed every second.',
    'f2t': 'Metric history',
    ...
    'f6t': 'System cleaner',
    'f6d': 'Trash, caches, /var/log, systemd journal, pacman cache and orphan packages.',
    'f7t': '/etc/hosts',
    ...
    'res.t': 'Resources',
    'res.d': 'Five charts with 60 seconds of history. Data accumulates while the app is running and is not reset when you switch pages.',
    ...
    'clean.d': 'Six categories with size calculation. Tick the items you need, see the total size and remove them; selections persist across restarts.',
    'clean.a': 'Trash, application caches, crash reports',
    'clean.b': 'System logs and systemd journal vacuum (50 MB)',
