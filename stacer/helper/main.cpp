...
class StacerHelper : public QObject
{
    Q_OBJECT
...
ActionReply StacerHelper::clean(const QVariantMap &args)
{
...
ActionReply StacerHelper::writehosts(const QVariantMap &args)
{
...
KAUTH_HELPER_MAIN(STACER_HELPER_ID, StacerHelper)
