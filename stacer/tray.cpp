    ...
    QObject(parent)
{
    ...
    m_item->setIconByName(QStringLiteral("stacer"));
    m_item->setTitle(QStringLiteral("Stacer"));
    m_item->setToolTip(QStringLiteral("stacer"), QStringLiteral("Stacer"), tr("Linux System Optimizer"));
    m_item->setStatus(KStatusNotifierItem::Active);

    auto *menu = new QMenu();
    QAction *showAction = menu->addAction(tr("Show Stacer"));
